      ...
      <Card className="max-w-3xl mx-auto shadow-lg">
        ...
        <CardContent className="space-y-6 text-center">
          ...
          <div className="text-left space-y-3 px-2 md:px-6">
            ...
            <p className="text-md text-foreground">
              Prakash is the developer of <strong className="text-primary">cortex</strong>, a company passionate about harnessing the power of artificial intelligence to create impactful and user-centric solutions.
            </p>
          </div>
